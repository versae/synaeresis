...
function closewindow() {
    if (window.opener && window.opener.copyoutput) {
        window.opener.copyoutput(document.getElementById('{{ input_id }}').value);
        }
    }
...
function add(ch) { 
    ...
    if (document.getElementById('{{ input_id }}').style.display == 'none') { return; }
    var outputNode = document.getElementById( '{{ input_id }}' ); // points to the output textarea
...
function deleteAll () {
    var outputNode = document.getElementById( '{{ input_id }}' );
    outputNode.value = "";
    }

function selectFont ( newFont ) {
    document.getElementById( '{{ input_id }}' ).style.fontFamily = newFont;
...
function changeFontSize ( newSize ) {
    document.getElementById( '{{ input_id }}' ).style.fontSize = newSize + 'px';
...
function hideOutput () {
    document.getElementById('{{ input_id }}').style.height = '0px'; 
    document.getElementById('restoreOutput').style.display = 'block';
    document.getElementById('buttons').style.display = 'none';
    }
    
function unhideOutput () {
    if (document.getElementById('{{ input_id }}').style.display == 'none') {
        //document.getElementById('{{ input_id }}').style.height = (document.getElementById('rows').value*100)+'px';
...
function initialise() { 
    ...
    document.getElementById('{{ input_id }}').contentEditable = 'true';
    ...
    var transcriptnodes = document.getElementById('phonemelist').childNodes; 
